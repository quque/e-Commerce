  ...
  <div id="app">
   ...
   <div class="header">
        ...
        <div class="head-top">
            <div class="section">
                <div class="left-box">
                    <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">买买买</font></font></span>
                ...
                <div id="menu" class="right-box">
                    ...
                    <router-link to="/shoppingcar" >
                        <i class="iconfont icon-cart"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">购物车（
                         </font><span id="shoppingCartCount"><span><font style="vertical-align: inherit;"></font></span></span><font style="vertical-align: inherit;">）</font></font><span id="shoppingCartCount">
...
<style>
@import url("./assets/css/statics/site/css/style.css");
</style>